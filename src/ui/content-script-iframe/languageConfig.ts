    ...
    provideCompletionItems: (model, position) => {
      ...
      const suggestions = [
        ...
        },
        {
          label: 'for',
          kind: monaco.languages.CompletionItemKind.Keyword,
          insertText: 'for (${1:$i = 0}; ${2:$i < $length}; ${3:$i++}) {\n    ${4:// loop body}\n}',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
          documentation: 'For loop',
          range: range
        },
    ...
    provideCompletionItems: (model, position) => {
      ...
      const suggestions = [
        ...
        },
        {
          label: 'ALTER TABLE',
          kind: monaco.languages.CompletionItemKind.Keyword,
          insertText: 'ALTER TABLE ${1:table_name} ${2:ADD COLUMN ${3:column_name} ${4:datatype}}',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
        ...
        },
        {
          label: 'JOIN',
          kind: monaco.languages.CompletionItemKind.Keyword,
          insertText: 'JOIN ${1:table2} ON ${2:table1.column} = ${3:table2.column}',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
        ...
        },
        {
          label: 'LEFT JOIN',
          kind: monaco.languages.CompletionItemKind.Keyword,
          insertText: 'LEFT JOIN ${1:table2} ON ${2:table1.column} = ${3:table2.column}',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    ...
    provideCompletionItems: (model, position) => {
      ...
      const suggestions = [
        ...
        },
        {
          label: 'fn',
          kind: monaco.languages.CompletionItemKind.Keyword,
          insertText: 'fn ${1:function_name}(${2:parameters}) ${3:-> return_type} {\n    ${4:// function body}\n}',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
          documentation: 'Define a function',
          range: range
        },
    ...
    provideCompletionItems: (model, position) => {
      ...
      const suggestions = [
        ...
        },
        {
          ...
          kind: monaco.languages.CompletionItemKind.Snippet,
          insertText: 'for (${1:const auto&} ${2:item} : ${3:container}) {\n    ${4:// loop body}\n}',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
        ...
        },
        {
          ...
          kind: monaco.languages.CompletionItemKind.Class,
          insertText: 'std::shared_ptr<${1:Type}> ${2:ptrName} = std::make_shared<${1:Type}>(${3:args});',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
        ...
        },
        {
          ...
          kind: monaco.languages.CompletionItemKind.Class,
          insertText: 'std::unique_ptr<${1:Type}> ${2:ptrName} = std::make_unique<${1:Type}>(${3:args});',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
...
export function setupHoverProviders() {
  ...
  monaco.languages.registerHoverProvider('java', {
    provideHover: function (model, position) {
      ...
      const hoverInfo: Record<string, string> = {
        'System': 'Final class that contains several useful class fields and methods',
